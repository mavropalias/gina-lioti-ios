...
//        }, failure: nil)
    ...
    func application(_ application: UIApplication, continue userActivity: NSUserActivity, restorationHandler: ([AnyObject]?) -> Void) -> Bool {
        if  userActivity.activityType == CSSearchableItemActionType {
            ...
            navController.popToRootViewController(animated: false) // Navigate to root view
...
//        }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main().urlForResource("Gina_Lioti_Cooking", withExtension: "momd")!
